...
module "alb" {
  source                      = "git::https://github.com/Pavansaidevops/tf-module-alb.git"
  for_each                    = var.alb
...
module "elasticache" {
  source                      = "git::https://github.com/Pavansaidevops/tf-module-elasticache.git"
...
module "rabbitmq" {
  source                      = "git::https://github.com/Pavansaidevops/tf-module-rabbitmq.git"
...
module "app" {
  ...
  source                      = "git::https://github.com/Pavansaidevops/tf-module-app.git"
  for_each                    = var.apps
  zone_id                     = var.zone_id
